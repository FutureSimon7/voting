...
const contract_id = {
  ...
  txId: "06d53d19a5730d5de8efb4bc4dbc557e025ca3bad99c734f6a84b3294911ddbe",
  /** The output index */
  outputIndex: 0,
};
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h2>Who is the nexe president?</h2>
      </header>
      <TableContainer
        component={Paper}
        variant="outlined"
              ...
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"iphone"}
                    src={`${process.env.PUBLIC_URL}/${"joe"}.png`}
                  />
                </Box>
              </TableCell>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"android"}
                    src={`${process.env.PUBLIC_URL}/${"trump"}.png`}
                  />
                </Box>
              </TableCell>
            </TableRow>
